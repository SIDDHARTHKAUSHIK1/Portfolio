        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building robust, scalable web applications and REST APIs using modern JavaScript/TypeScript ecosystems and databases.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Developing intelligent systems, computer vision pipelines, and integrating machine learning models with cloud-native architectures.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
